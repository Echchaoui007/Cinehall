            ...
            <div class="row gap-2 ">
                <div style="width: 24%;" class="card   cl-2  mt-5 pt-4" v-for="res in resrvation" key="res">
                    <div class="d-flex sale ">
                        <div class="btn" :class="{ 'disple': outResrvastion.includes(res.id_film) }"
                            v-on:click="deleteResrvstion(res.id_res)">delete</div>
                    </div>
                    <img class='mx-auto img-thumbnail h-100 w-100' :src="res.image" alt="" />
