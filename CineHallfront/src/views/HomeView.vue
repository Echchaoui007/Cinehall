...
import txtanmtion from '../components/txtanmtion.vue';
</script>
      ...
      <div class="container hero">
        <div class="row">
          <div class="col-12 col-lg-6 col-xl-5 offset-xl-1">
            <h1>We Have Best Movies</h1>
            <button class="btn btn-light btn-lg action-button" type="button">See More<i
...
<style>
.header-blue {
  background: linear-gradient(135deg, #ff5f5f, #980527);
